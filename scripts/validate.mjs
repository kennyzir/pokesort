...
const required = ["index.html", "pokesort-alternative/index.html", "pokesort-down/index.html", "privacy/index.html", "assets/styles.css", "assets/game.js", "robots.txt", "sitemap.xml"];
...
if ((game.match(/mons: \[/g) || []).length < 12) throw new Error("Expected at least 12 puzzle groups");
